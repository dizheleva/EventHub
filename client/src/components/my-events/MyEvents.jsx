...
export default function MyEvents() {
    ...
    const myEvents = useMemo(() => {
        ...
        // Филтрираме събитията, които принадлежат на текущия потребител
        // Включваме и временните събития (temp-), ако имат правилния _ownerId
        return events.filter(event => {
            // Проверяваме дали _ownerId съвпада (стриктно сравнение)
            return event && event._ownerId && event._ownerId === user._id;
        });
        ...
        return (
            <section className="max-w-7xl mx-auto px-4 py-12">
                <div className="text-center py-12">
                    <h3 className="text-2xl text-gray-500 font-medium">Трябва да сте логнати, за да видите вашите събития</h3>
                </div>
            </section>
        );
    }
    ...
    return (
        <section className="max-w-7xl mx-auto px-4 py-12">
            <h1 className="text-4xl font-bold mb-8 text-gray-900 text-center">Мои Събития</h1>
            ...
            {isLoading ? (
                ...
                <div className="text-center py-12">
                    <h3 className="text-2xl text-gray-500 font-medium">Все още нямате добавени събития</h3>
                    <button
