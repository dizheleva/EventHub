...
export default function EditEventForm({ eventId, onEventUpdated, onCancel, isSubmitting }) {
    ...
    const editEventHandler = async (values) => {
        const data = {
            ...
            date: values.startDate || values.date,
        ...
        try {
            ...
            showToast('error', err.message || 'Грешка при обновяване на събитието');
            throw err;
        }
    };
    ...
    useEffect(() => {
        ...
        // Parse location - градът е първата част
        let address = '';
        let city = '';
        let isOnline = false;
