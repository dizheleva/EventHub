...
import Sorting from "../../common/navigation/Sorting";

function EventsFilters({ filters, onChange, cities = [] }) {
  const { city = "", category = "", price = "", date = "" } = filters || {};
  const [openDropdown, setOpenDropdown] = useState(null);
  const filtersRef = useRef(null);

  // Map for all current filter values
  const filterValues = { city, category, price, date };
...
// Export EventsFilters as named export for direct use
export { EventsFilters };

// Wrapper component that includes Sorting and EventsFilters together
export default function EventsFiltersBar({ filters, onFiltersChange, onSortChange, cities, sortBy, sortOrder }) {
  return (
