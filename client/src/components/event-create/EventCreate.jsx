...
export default function EventCreate() {
    ...
    const createEventHandler = async (values) => {
        ...
        const data = {
            ...
            date: values.startDate, // Keep date for backward compatibility
        ...
        try {
            ...
            if (result && result._id) {
                ...
                alert('Грешка при създаване на събитието: Невалиден отговор от сървъра');
            }
        } catch (err) {
            alert(err.message || 'Грешка при създаване на събитието');
        }
    };
    ...
    return (
        <section className="max-w-3xl mx-auto px-4 py-12">
            <div className="bg-white rounded-2xl shadow-soft p-6 md:p-10">
                <h1 className="text-3xl font-bold text-gray-900 mb-8 text-center">Добави ново събитие</h1>
